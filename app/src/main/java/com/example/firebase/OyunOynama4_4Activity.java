...
public class OyunOynama4_4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oyun_oynama44);
        ...
        sure = findViewById(R.id.sure1Goster);
        skor = findViewById(R.id.skor1Goster);
        anah = findViewById(R.id.switch3);
        ...
        Toast.makeText(OyunOynama4_4Activity.this, "KARTLAR YÜKLENİYOR", Toast.LENGTH_SHORT).show();
        ...
        mfirestore.collection("CardCollection").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    player=MediaPlayer.create(OyunOynama4_4Activity.this,R.raw.prologue);
                    ...
                    runnable=new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (zaman != 0 && zaman>0) {
                                ...
                                AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(OyunOynama4_4Activity.this);
                                alertDialogBuilder.setMessage("Oyun Bitti").setCancelable(false).setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent=new Intent(getApplicationContext(),OyunOynama4_4Activity.class);
                                ...
                                alertDialog.show();
                                player4=MediaPlayer.create(OyunOynama4_4Activity.this,R.raw.shocked);
                                if(anah.isChecked()){
                                    player.pause();
                                    player.seekTo(0);
                                    player4.start();
    ...
    private void calculate() {
        ...
        player2=MediaPlayer.create(OyunOynama4_4Activity.this,R.raw.victory);
    ...
    private void checkEnd() {
        if(control[0]==1 && control[1]==2 && control[2]==3 &&
            ...
            player3=MediaPlayer.create(OyunOynama4_4Activity.this,R.raw.congratulations);
            /*player.pause();
            player2.pause();
            player3.start();
            player.seekTo(0);
